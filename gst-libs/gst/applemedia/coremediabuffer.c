...
static void
gst_core_media_meta_free (GstMeta * gmeta, GstBuffer * buf)
{
  GstCoreMediaMeta *meta;

  meta = (GstCoreMediaMeta *) gmeta;
...
static gboolean
gst_core_media_meta_transform (GstBuffer * transbuf, GstMeta * gmeta,
    ...
    CMBlockBufferRef block_buf)
{
  ...
  do {
    ...
    if (offset + length_at_offset >= total_length)
      break;
