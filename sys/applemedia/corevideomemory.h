...
GstCoreVideoPixelBuffer *
gst_core_video_pixel_buffer_ref (GstCoreVideoPixelBuffer * shared);

void
gst_core_video_pixel_buffer_unref (GstCoreVideoPixelBuffer * shared);

gboolean
gst_is_core_video_memory (GstMemory * mem);

GstMemory *
gst_core_video_memory_new_wrapped (GstCoreVideoPixelBuffer * shared, gsize plane, gsize size);
